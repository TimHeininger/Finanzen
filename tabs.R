...
#*
#*#**************************************************************************************************************************************************
# Dashboard Schadenrueckstellungen ----
#****************************************************************************************************************************************************

# .tab_schadenrueckstellungen <- tabItem(tabName ="schadenrueckstellungen",
#                                        h2("Schadenrueckstellungen"),
#                                        br(),
#                                        br(),
#                                        fluidRow(
#                                          column(width = 4,
#                                                 actionButton("srs_aufbereiten_berechnen","Inputs aufbereiten und SRS berechnen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                                 br(),
#                                                 br(),
#                                                 textOutput("srs_ist_berechnet"),
#                                                 br(),
#                                                 br()
#                                                 ),
#                                          column(width = 8,
#                                                 textOutput("kontrollen_srs_alles_auf_true"),
#                                                 br(),
#                                                 textOutput("kontrollen_srs_gespeichert"),
#                                                 br(),
#                                                 DTOutput("validierung_kontrollen_srs_anzeige"))
#                                        ),
# 			       fluidRow(
# 				 column(width = 4,
# 				 actionButton("srs_ergebnisse_speichern","Ergebnisse der Berechnung speichern", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                         br(),
# 				 br(),
# 				 textOutput("srs_speichern"))
# 				 ),
# 				 fluidRow(
# 				   column(width = 4,
# 				          actionButton("input_laufzeitbaender_speichern","Input-Tabellen für Laufzeitbänder erzeugen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
# 				          br(),
# 				          br(),
# 				          textOutput("laufzeitbaender_speichern"))
#                                        )
# 
# )
#****************************************************************************************************************************************************
...
#****************************************************************************************************************************************************
# Dashboard Praemienrueckstellungen ----
#****************************************************************************************************************************************************

# .tab_praemienrueckstellungen <- tabItem(tabName = "praemienrueckstellungen",
#                                    h2("Berechnung der Prämienrückstellungen"),
#                                    br(),
#                                    br(),
#                                    fluidRow(
#                                      column(width = 4,
#                                             actionButton("prs_aufbereiten_berechnen","Inputs aufbereiten und PRS berechnen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                             br(),
#                                             br(),
#                                             textOutput("prs_ist_berechnet"),
#                                             br(),
#                                             br()
#                                      ),
#                                      column(width = 8,
#                                             textOutput("kontrollen_prs_alles_auf_true"),
#                                             br(),
#                                             textOutput("kontrollen_prs_gespeichert"),
#                                             br(),
#                                             DTOutput("validierung_kontrollen_prs_anzeige"))
#                                    ),
#                                    fluidRow(
#                                      column(width = 4,
#                                             actionButton("prs_ergebnisse_speichern","Ergebnisse der Berechnung speichern", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                             br(),
#                                             br(),
#                                             textOutput("prs_speichern")) 
#                                    )
#                                    
# )
...
#****************************************************************************************************************************************************
# Dashboard Ausfallrisiko ----
#****************************************************************************************************************************************************

# .tab_ausfallrisiko <- tabItem(tabName = "ausfallrisiko",
#                                         h2("Berechnung des Ausfallrisikos"),
#                                         br(),
#                                         br(),
#                                         fluidRow(
#                                           column(width = 4,
#                                                  actionButton("ausfallrisiko_aufbereiten_berechnen","Inputs aufbereiten und Ausfallrisiko berechnen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                                  br(),
#                                                  br(),
#                                                  textOutput("ausfallrisiko_ist_berechnet")
#                                           ),
#                                           column(width = 8,
#                                                  textOutput("kontrollen_ausfallrisiko_alles_auf_true"),
#                                                  br(),
#                                                  textOutput("kontrollen_ausfallrisiko_gespeichert"),
#                                                  br(),
#                                                  DTOutput("validierung_kontrollen_ausfallrisiko_anzeige"))
#                                         ),
#                               fluidRow(
#                                 column(width = 4,
#                                        actionButton("ausfallrisiko_ergebnisse_speichern","Ergebnisse der Berechnung speichern", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                        br(),
#                                        br(),
#                                        textOutput("ausfallrisiko_speichern")) 
#                               )
#                                         
# )
...
#****************************************************************************************************************************************************
# Dashboard Stornorisiko ----
#****************************************************************************************************************************************************

# .tab_stornorisiko <- tabItem(tabName = "stornorisiko",
#                               h2("Berechnung des Stornorisikos"),
#                               br(),
#                               br(),
#                               fluidRow(
#                                 column(width = 4,
#                                        actionButton("stornorisiko_aufbereiten_berechnen","Inputs aufbereiten und Stornorisiko berechnen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                        br(),
#                                        br(),
#                                        textOutput("stornorisiko_ist_berechnet")
#                                 )
#                               ),
#                              fluidRow(
#                                column(width = 4,
#                                       actionButton("stornorisiko_ergebnisse_speichern","Ergebnisse der Berechnung speichern", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                       br(),
#                                       br(),
#                                       textOutput("stornorisiko_speichern")) 
#                              )
#                               
# )
...
#****************************************************************************************************************************************************
# Dashboard Schnittstelle befüllen ----
#****************************************************************************************************************************************************

# .tab_schnittstelle_befuellen <- tabItem(tabName = "schnittstelle_befuellen",
#                              h2("Schnittstellen befüllen"),
#                              br(),
#                              br(),
#                              h3("Es werden die folgenden Schnittstellen befüllt:"),
#                              h4("- Schnittstelle ZAK,"),
#                              h4("- Schnittstelle RH,"),
#                              h4("- Recoverables_RVV sowie"),
#                              h4("- Zulieferung_Kontrahentenrisiko_KH-ZB-RG"),
#                              fluidRow(
#                                column(width = 4,
#                                       actionButton("schnittstellen_befuellen","Schnittstellen befüllen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                       br(),
#                                       br(),
#                                       textOutput("schnittstellen_befuellt")
#                                ),
#                                column(width = 8,
#                                       textOutput("kontrollen_schnittstellen_alles_auf_true"),
#                                       br(),
#                                       textOutput("kontrollen_schnittstellen_gespeichert"),
#                                       br(),
#                                       DTOutput("validierung_kontrollen_schnittstellen_anzeige"))
#                              )
#                             
# 
# )
...
# .tab_sonstiges <- tabItem(tabName = "sonstiges",
#                                         fluidRow(
#                                           column(width = 6,
#                                                  h2("Ausweis aller Gegenparteien"),
#                                                  br(),
#                                                  br(),
#                                                  actionButton("input_vertraege_mit_rv_abfragen","DSS Abfrage: Input_Verträge_mit_RV", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                                  br(),
#                                                  textOutput("input_vertraege_mit_rv_abgefragt"),
#                                                  br(),
#                                                  br(),
#                                                  actionButton("ausweis_gegenparteien_inputs_einlesen","Inputs einlesen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                                  br(),
#                                                  textOutput("ausweis_gegenparteien_inputs_sind_eingelesen"),
#                                                  br(),
#                                                  br(),
#                                                  actionButton("ausweis_gegenparteien_berechnen","Makleraufteilung berechnen", icon = icon("earlybirds", class = NULL, lib = "font-awesome")),
#                                                  br(),
#                                                  textOutput("ausweis_gegenparteien_berechnet")
#                                                  
#                                           ),
#                                           column(width = 6,
#                                                  textOutput("kontrollen_ausweis_aller_gegenparteien_alles_auf_true"),
#                                                  br(),
#                                                  textOutput("kontrollen_ausweis_aller_gegenparteien_gespeichert"),
#                                                  br(),
#                                                  DTOutput("validierung_kontrollen_ausweis_aller_gegenparteien_anzeige"))
#                                         )
#                                         
#                                         
# )
